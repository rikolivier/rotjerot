...
const handleLoading = () => {
  ...
  return (
    <>
      ...
      <button className="bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" onClick={handleLoading}>{isLoading ? 'loading' : "Start fermentation"}</button>
      </main>   
    </>
  );  
};
